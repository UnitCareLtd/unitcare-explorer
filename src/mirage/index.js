...
exports.makeServer = function makeServer({ environment = "development" } = {}) {
    return new Server({
        ...
        routes() {
            this.get("https://raw.githubusercontent.com/UNITCAREEcosystem/common/master/mainnet/known-wallets.json", () => {
                return {
                    ...
                    AXxNbmaKspf9UqgKhfTRDdn89NidP2gXWh: "UNITCARE Bounty",
                    AYCTHSZionfGoQsRnv5gECEuFWcZXS38gs: "UNITCARE Bounty Hot Wallet",
                    AZmQJ2P9xg5j6VPZWjcTzWDD4w7Qww2KGX: "UNITCARE GitHub Bounty",
                    ANkHGk5uZqNrKFNY5jtd4A88zzFR3LnJbe: "UNITCARE Hot Wallet",
                    AHJJ29sCdR5UNZjdz3BYeDpvvkZCGBjde9: "UNITCARE Shield",
                    AdTyTzaXPtj1J1DzTgVksa9NYdUuXCRbm1: "UNITCARE Shield (old)",
                    AXzxJ8Ts3dQ2bvBR1tPE7GUee9iSEJb8HX: "UNITCARE Team",
                    AUDud8tvyVZa67p3QY7XPRUTjRGnWQQ9Xv: "UNITCARE Team (old)",
            ...
            // UNITCARE API
            this.urlPrefix = "https://explorer.unitcare.co";
            this.namespace = "api";
