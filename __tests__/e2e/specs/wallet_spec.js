describe("Wallet", () => {
    ...
    it("should show who the wallet voted for", () => {
        cy.visit("wallets/UNIq9nhjCxwpWnGKDgxveAJSijNG8Y6dFQ");
    ...
    it("should be possible to navigate to the list of forged blocks", () => {
        ...
        cy.get("h1")
            ...
            .then(($heading) => {
                ...
                cy.url().should("include", "/wallets/UNIq9nhjCxwpWnGKDgxveAJSijNG8Y6dFQ/blocks/1");
            });
    });
    ...
    it("should be possible to navigate to the list of voters", () => {
        ...
        cy.get("h1")
            ...
            .then(($heading) => {
                ...
                cy.url().should("include", "/wallets/UNIq9nhjCxwpWnGKDgxveAJSijNG8Y6dFQ/voters/1");
            });
    });
